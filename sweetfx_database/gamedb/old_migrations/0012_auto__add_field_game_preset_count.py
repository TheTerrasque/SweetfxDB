...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PresetScreenshot', fields ['visible']
        db.create_index('gamedb_presetscreenshot', ['visible'])

        # Adding field 'Game.preset_count'
        db.add_column('gamedb_game', 'preset_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding index on 'Game', fields ['visible']
        db.create_index('gamedb_game', ['visible'])

        # Adding index on 'Preset', fields ['visible']
        db.create_index('gamedb_preset', ['visible'])


    def backwards(self, orm):
        # Removing index on 'Preset', fields ['visible']
        db.delete_index('gamedb_preset', ['visible'])

        # Removing index on 'Game', fields ['visible']
        db.delete_index('gamedb_game', ['visible'])

        # Removing index on 'PresetScreenshot', fields ['visible']
        db.delete_index('gamedb_presetscreenshot', ['visible'])

        # Deleting field 'Game.preset_count'
        db.delete_column('gamedb_game', 'preset_count')
