...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Shader'
        db.create_table('gamedb_shader', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('download', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['downloads.DownloadFile'], null=True)),
        ))
        db.send_create_signal('gamedb', ['Shader'])

        # Adding field 'Preset.shader'
        db.add_column('gamedb_preset', 'shader',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gamedb.Shader'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Shader'
        db.delete_table('gamedb_shader')

        # Deleting field 'Preset.shader'
        db.delete_column('gamedb_preset', 'shader_id')
    ...
    models = {
        ...
        'gamedb.shader': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'download': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['downloads.DownloadFile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
