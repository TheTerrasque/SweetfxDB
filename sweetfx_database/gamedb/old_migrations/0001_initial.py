...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gamedb_game', (
            ...
            ('exename', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ...
        # Adding model 'Preset'
        db.create_table('gamedb_preset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('settings_text', self.gf('django.db.models.fields.TextField')()),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gamedb.Game'])),
        ))
        db.send_create_signal('gamedb', ['Preset'])

        # Adding model 'PresetScreenshot'
        db.create_table('gamedb_presetscreenshot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('preset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gamedb.Preset'])),
        ...
        db.send_create_signal('gamedb', ['PresetScreenshot'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('gamedb_preset')

        # Deleting model 'PresetScreenshot'
        db.delete_table('gamedb_presetscreenshot')
    ...
    models = {
        ...
        'gamedb.game': {
            ...
            'exename': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
