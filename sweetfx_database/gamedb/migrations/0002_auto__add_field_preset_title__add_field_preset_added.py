...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Preset.title'
        db.add_column('gamedb_preset', 'title',
                      self.gf('django.db.models.fields.CharField')(default='Default', max_length=40),
                      keep_default=False)

        # Adding field 'Preset.added'
        db.add_column('gamedb_preset', 'added',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2012, 11, 14, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Preset.title'
        db.delete_column('gamedb_preset', 'title')

        # Deleting field 'Preset.added'
        db.delete_column('gamedb_preset', 'added')
