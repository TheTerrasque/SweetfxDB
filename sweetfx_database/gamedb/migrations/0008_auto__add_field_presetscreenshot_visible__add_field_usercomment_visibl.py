...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PresetScreenshot.visible'
        db.add_column('gamedb_presetscreenshot', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserComment.visible'
        db.add_column('gamedb_usercomment', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Preset.visible'
        db.add_column('gamedb_preset', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PresetScreenshot.visible'
        db.delete_column('gamedb_presetscreenshot', 'visible')

        # Deleting field 'UserComment.visible'
        db.delete_column('gamedb_usercomment', 'visible')

        # Deleting field 'Preset.visible'
        db.delete_column('gamedb_preset', 'visible')
