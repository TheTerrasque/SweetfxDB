...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PresetScreenshot.comparison_image'
        db.add_column('gamedb_presetscreenshot', 'comparison_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PresetScreenshot.medium_thumb_compared'
        db.add_column('gamedb_presetscreenshot', 'medium_thumb_compared',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PresetScreenshot.comparison_image'
        db.delete_column('gamedb_presetscreenshot', 'comparison_image')

        # Deleting field 'PresetScreenshot.medium_thumb_compared'
        db.delete_column('gamedb_presetscreenshot', 'medium_thumb_compared')
