...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Preset.screenshot_count'
        db.add_column('gamedb_preset', 'screenshot_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Preset.screenshot_count'
        db.delete_column('gamedb_preset', 'screenshot_count')
