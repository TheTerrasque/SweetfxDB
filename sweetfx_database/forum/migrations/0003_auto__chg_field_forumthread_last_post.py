...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ForumThread.last_post'
        raise RuntimeError("Cannot reverse this migration. 'ForumThread.last_post' and its values cannot be restored.")
