...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ForumThread.last_post'
        db.add_column('forum_forumthread', 'last_post',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['forum.ForumPost']),
                      keep_default=False)

        # Adding field 'ForumPost.created'
        db.add_column('forum_forumpost', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 11, 19, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ForumThread.last_post'
        db.delete_column('forum_forumthread', 'last_post_id')

        # Deleting field 'ForumPost.created'
        db.delete_column('forum_forumpost', 'created')
    ...
    models = {
        ...
        'forum.forumthread': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['forum.ForumPost']"}),
