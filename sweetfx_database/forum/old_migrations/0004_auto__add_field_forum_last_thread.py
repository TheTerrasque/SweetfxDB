...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Forum.last_thread'
        db.add_column('forum_forum', 'last_thread',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='forum2', null=True, to=orm['forum.ForumThread']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Forum.last_thread'
        db.delete_column('forum_forum', 'last_thread_id')
    ...
    models = {
        ...
        'forum.forum': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_thread': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'forum2'", 'null': 'True', 'to': "orm['forum.ForumThread']"}),
        ...
        'forum.forumthread': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['forum.ForumPost']", 'null': 'True', 'blank': 'True'}),
