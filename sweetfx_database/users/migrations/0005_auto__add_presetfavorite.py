...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PresetFavorite'
        db.create_table('users_presetfavorite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('preset', self.gf('django.db.models.fields.related.ForeignKey')(related_name='favorites', to=orm['gamedb.Preset'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='favorites', to=orm['auth.User'])),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('users', ['PresetFavorite'])


    def backwards(self, orm):
        # Deleting model 'PresetFavorite'
        db.delete_table('users_presetfavorite')
    ...
    models = {
        ...
        'users.alert': {
            'Meta': {'ordering': "['-id']", 'object_name': 'Alert'},
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'text': ('django.db.models.fields.TextField', [], {})
        },
        'users.presetfavorite': {
            'Meta': {'object_name': 'PresetFavorite'},
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'preset': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'favorites'", 'to': "orm['gamedb.Preset']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'favorites'", 'to': "orm['auth.User']"})
        },
        'users.theme': {
            'Meta': {'object_name': 'Theme'},
            'css': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        'users.userprofile': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'theme': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Theme']", 'null': 'True', 'blank': 'True'}),
