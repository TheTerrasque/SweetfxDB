...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PresetFavorite', fields ['preset', 'user']
        db.create_unique('users_presetfavorite', ['preset_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PresetFavorite', fields ['preset', 'user']
        db.delete_unique('users_presetfavorite', ['preset_id', 'user_id'])
    ...
    models = {
        ...
        'users.presetfavorite': {
            'Meta': {'unique_together': "(('preset', 'user'),)", 'object_name': 'PresetFavorite'},
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
